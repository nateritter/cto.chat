                            ...
                            <?php if (empty($_GET['email'])) : ?>
                                <div class="mt-6">
                                    <div class="inline-flex items-center divide-x divide-gray-300">
                                        ...
                                        <div class="flex-1 min-w-0 py-1 pl-5 text-sm text-gray-500 sm:py-3"><span class="font-medium text-gray-900">Rated 5 stars</span> by <span class="font-medium text-rose-500">the guy  building it</span></div>
                                    </div>
                                <?php endif; ?>
                                </div>
                        </div>
